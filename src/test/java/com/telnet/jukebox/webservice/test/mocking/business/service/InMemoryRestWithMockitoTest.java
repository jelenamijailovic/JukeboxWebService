...
public class InMemoryRestWithMockitoTest {
    ...
    public static class MyResource {
        ...
        public ZanrDTO createMyModel(int id) {

            return backendService.getMyModel(id);
        }
    ...
    public void postWithoutMocking() throws Exception {
        ...
        Response response = server.newRequest("/myresource").request().buildPost(Entity.text("5")).invoke();
    ...
    public void postWithMocking() throws Exception {
        ...
        when(backendServiceMock.getMyModel(5)).thenReturn(new ZanrDTO(5));

        Response response = server.newRequest("/myresource").request().buildPost(Entity.text("5")).invoke();
        assertEquals(Response.Status.OK.getStatusCode(), response.getStatus());

        ZanrDTO myModel = response.readEntity(ZanrDTO.class);
        assertEquals(42, myModel.getId());
    }
}
*/